...
# Download machine-agent v1.10.0

wget -O /tmp/machine-agent.tar.gz "https://dl.depot.dev/machine-agent/download/linux/$(uname -m)/v1.10.0"
...
buildkit_version="v0.11.5-depot.3"
